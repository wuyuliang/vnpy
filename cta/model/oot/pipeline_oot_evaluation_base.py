...
from cta.model.oot.block_reasons import BR_BLOCKED_CLUSTER_CAP, BR_BLOCKED_DAILY_POSITION, BR_BLOCKED_FINAL_DECISION_GATE, BR_BLOCKED_LEVERAGE, BR_BLOCKED_MARGIN_CASH, BR_BLOCKED_MFE_MAE_GATE, BR_BLOCKED_MONTHLY_DRAWDOWN, BR_BLOCKED_PORTFOLIO_CONSTRAINT, BR_BLOCKED_REGIME_GATE, BR_BLOCKED_SYMBOL_CAP, BR_BLOCKED_TRADE_FILTER, BR_BLOCKED_TOTAL_CONCURRENT, BR_BLOCKED_WEEKLY_BUDGET, BR_BLOCKED_WEEKLY_DRAWDOWN, BR_HTF_MISSING, BR_LOG_EXECUTED_SENTINEL, BR_ZERO_NOTIONAL
