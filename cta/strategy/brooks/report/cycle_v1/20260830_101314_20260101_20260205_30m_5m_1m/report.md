...
```bash
cd /Users/wuyuliang/code/vnpy && python3 -m cta.strategy.brooks.cycle_v1.backtest.runner --symbols AG --start 2026-01-01 --end 2026-02-05 --long-tf 30min --medium-tf 5min --short-tf 1min --initial-equity 200000 --download-minute-data --download-audit-output cta/strategy/brooks/report/cycle_v1/20260830_ag_backtest_minute_download_20250830_20260205.json
```
