...
- reason: conflicting exchange_calendar.csv row SHFE,2026-01-05: source
...
## Metadata Gaps
- ALL execution_metadata_preparation: BLOCKED_METADATA conflicting exchange_calendar.csv row SHFE,2026-01-05: source
